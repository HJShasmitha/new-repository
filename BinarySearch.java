...
public class BinarySearch {
    ...
    // It's return that the value not the element of index no.
        ...
        while(intial <= last){
            //  int center = (intial + last) / 2;
             int center = intial + (last - intial) /2;  // Use this in the largest no.of comparsion--> int center = intial + (last - intial) /2;
             int a = arr[center];
